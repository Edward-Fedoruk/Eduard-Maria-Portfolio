...
"use strict";particlesJS.load("particles-js","js/particlesjs-config.json"),particlesJS.load("particle","js/particlesjs-config.json"),$(window).on("load",function(n){AOS.init({duration:1200,once:!0})});var sectionOffsets=[];$(".navigation__navItem").each(function(n){var t=$(this).data("link");sectionOffsets.push($(t).offset().top)});var prevIndex=-1,win=$(window),interval=null;$(window).on("scroll",function(n){clearTimeout(interval),interval=setTimeout(function(){var n=win.scrollTop(),t=sectionOffsets.findIndex(function(t){return n<=t});if(prevIndex!==t){var a=$(".navigation__navItem .hr").get(prevIndex),o=$(".navigation__navItem").get(t);$(a).removeClass("hr-active"),$(o).find(".hr").addClass("hr-active"),prevIndex=t}},10)}),$(".navigation__navItem").on("click",function(n){var t=$(this).data("link");$("html, body").animate({scrollTop:$(t).offset().top},2e3,"swing")}),setInterval(function(){var n=Math.round(200*Math.random())+50,t=Math.round(100*Math.random())+25;$(".about__particle").css("background-color","rgb(".concat(254,", ").concat(n,", ").concat(t,")")),$(".contact__writeUs").css("color","rgb(".concat(254,", ").concat(n,", ").concat(t,")")),$(".contact__gmail").css("color","rgb(".concat(254,", ").concat(n,", ").concat(t,")"))},2e3);