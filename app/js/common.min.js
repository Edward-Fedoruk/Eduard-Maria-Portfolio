...
particlesJS.load("particles-js","../libs/particles/particlesjs-config.json"),particlesJS.load("particle","../libs/particles/particlesjs-config.json"),$(window).on("load",function(o){AOS.init({duration:1200,once:!0})});let count=2,startOffsetY=$(".navigation").offset().top;$(window).on("scroll",function(o){$(window).scrollTop()-$(".navigation").height()-startOffsetY<$(".navigation").offset().top-$(window).scrollTop()&&$(".navigation").css({top:startOffsetY-$(window).scrollTop()/count+"px"})});