...
particlesJS.load("particles-js","../libs/particles/particlesjs-config.json"),particlesJS.load("particle","../libs/particles/particlesjs-config.json"),$(window).on("load",function(t){AOS.init({duration:1200,once:!0})});let startOffsetY=$(".navigation").offset().top-$(window).scrollTop();$(window).on("scroll",function(t){$(window).scrollTop()-$(".navigation").height()-startOffsetY<$(".navigation").offset().top-$(window).scrollTop()&&$(".navigation").css({top:startOffsetY-$(window).scrollTop()/2+"px"})}),$(".navigation__navItem").on("click",function(t){let i=$(this).data("link");$(".navigation__navItem .hr").each(function(t){$(this).removeClass("hr-active")}),$(this).find(".hr").addClass("hr-active"),$("html, body").animate({scrollTop:$(i).offset().top},2e3,"swing")});