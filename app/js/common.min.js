...
particlesJS.load("particles-js","../libs/particles/particlesjs-config.json",function(){console.log("callback - particles.js config loaded")}),particlesJS.load("particle","../libs/particles/particlesjs-config.json",function(){console.log("callback - particles.js config loaded")}),$(window).on("load",function(l){});