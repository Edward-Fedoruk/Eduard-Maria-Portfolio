...
particlesJS.load("particles-js","js/particlesjs-config.json"),particlesJS.load("particle","js/particlesjs-config.json"),$(window).on("load",function(t){AOS.init({duration:1200,once:!0})});let startOffsetY=$(".navigation").offset().top-$(window).scrollTop();$(window).on("scroll",function(t){$(window).scrollTop()-$(".navigation").height()-startOffsetY<$(".navigation").offset().top-$(window).scrollTop()&&$(".navigation").css({top:startOffsetY-$(window).scrollTop()/3+"px"})});let sectionOffsets=[];$(".navigation__navItem").each(function(t){const n=$(this).data("link");sectionOffsets.push($(n).offset().top)});let prevIndex=-1;const win=$(window);let interval=null;$(window).on("scroll",function(t){clearTimeout(interval),interval=setTimeout(function(){const t=win.scrollTop(),n=sectionOffsets.findIndex(n=>t<=n);if(prevIndex===n)return;const o=$(".navigation__navItem .hr").get(prevIndex),i=$(".navigation__navItem").get(n);$(o).removeClass("hr-active"),$(i).find(".hr").addClass("hr-active"),prevIndex=n},10)}),$(".navigation__navItem").on("click",function(t){let n=$(this).data("link");$("html, body").animate({scrollTop:$(n).offset().top},2e3,"swing")}),setInterval(function(){const t=Math.round(70*Math.random())+74,n=Math.round(60*Math.random())+84,o=Math.round(50*Math.random())+54;$(".about__particle").css("background-color",`rgb(${t}, ${n}, ${o})`)},2e3);