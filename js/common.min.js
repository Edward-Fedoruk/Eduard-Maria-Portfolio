...
particlesJS.load("particles-js","../libs/particles/particlesjs-config.json"),particlesJS.load("particle","../libs/particles/particlesjs-config.json"),$(window).on("load",function(i){AOS.init({duration:1200})});