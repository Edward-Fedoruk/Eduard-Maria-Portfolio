...
particlesJS.load("particles-js",{particles:{number:{value:380,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5},image:{src:"img/github.svg",width:100,height:100}},opacity:{value:.5,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:3,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.4,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",bounce:!1,attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!0,mode:"grab"},onclick:{enable:!0,mode:"push"},resize:!0},modes:{grab:{distance:140,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200,duration:.4},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0}),particlesJS.load("particle",{particles:{number:{value:380,density:{enable:!0,value_area:800}},color:{value:"#ffffff"},shape:{type:"circle",stroke:{width:0,color:"#000000"},polygon:{nb_sides:5},image:{src:"img/github.svg",width:100,height:100}},opacity:{value:.5,random:!1,anim:{enable:!1,speed:1,opacity_min:.1,sync:!1}},size:{value:3,random:!0,anim:{enable:!1,speed:40,size_min:.1,sync:!1}},line_linked:{enable:!0,distance:150,color:"#ffffff",opacity:.4,width:1},move:{enable:!0,speed:6,direction:"none",random:!1,straight:!1,out_mode:"out",bounce:!1,attract:{enable:!1,rotateX:600,rotateY:1200}}},interactivity:{detect_on:"canvas",events:{onhover:{enable:!0,mode:"grab"},onclick:{enable:!0,mode:"push"},resize:!0},modes:{grab:{distance:140,line_linked:{opacity:1}},bubble:{distance:400,size:40,duration:2,opacity:8,speed:3},repulse:{distance:200,duration:.4},push:{particles_nb:4},remove:{particles_nb:2}}},retina_detect:!0}),$(window).on("load",function(e){AOS.init({duration:1200,once:!0})});let startOffsetY=$(".navigation").offset().top-$(window).scrollTop();$(window).on("scroll",function(e){$(window).scrollTop()-$(".navigation").height()-startOffsetY<$(".navigation").offset().top-$(window).scrollTop()&&$(".navigation").css({top:startOffsetY-$(window).scrollTop()/2+"px"})});let sectionOffsets=[];$(".navigation__navItem").each(function(e){const t=$(this).data("link");sectionOffsets.push($(t).offset().top)});let prevIndex=-1;const win=$(window);let interval=null;$(window).on("scroll",function(e){clearTimeout(interval),interval=setTimeout(function(){const e=win.scrollTop(),t=sectionOffsets.findIndex(t=>e<=t);if(prevIndex===t)return;const n=$(".navigation__navItem .hr").get(prevIndex),i=$(".navigation__navItem").get(t);$(n).removeClass("hr-active"),$(i).find(".hr").addClass("hr-active"),prevIndex=t},10)}),$(".navigation__navItem").on("click",function(e){let t=$(this).data("link");$("html, body").animate({scrollTop:$(t).offset().top},2e3,"swing")});